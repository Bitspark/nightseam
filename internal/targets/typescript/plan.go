...
var imported = []string{"DuplexError", "Wire", "WireModelContext", "WireCallOptions", "AdapterContext", "LiveOwner", "ValueAdapter", "ValueContext", "ValueOptions", "callWire", "emitWire", "registerWire", "wirePair", "encodePath", "conversion", "createValidator", "withDeclaration", "jsonAdapter", "familyTypeAdapter", "callableIdentity", "DeclarationIdentity", "declarationDigest", "identityHandler", "IDENTITY_METHOD", "prepareIdentity", "TypeExpression", "WireFamily"}
