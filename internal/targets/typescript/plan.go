...
var imported = []string{"DuplexError", "Wire", "WireModelContext", "AdapterContext", "LiveOwner", "ValueAdapter", "ValueContext", "ValueOptions", "callWire", "emitWire", "registerWire", "wirePair", "encodePath", "conversion", "createValidator", "withDeclaration", "TypeExpression", "WireFamily"}
...
func (p *plan) plan() {
	...
	bindings.Fix("generated adapter local", "context", "bindings", "slots", "environment", "observer", "hasModelHandler", "proxyServer", "proxyClient", "bindServer", "bindClient", "wire", "model", "adapter", "access", "binding", "bound")
