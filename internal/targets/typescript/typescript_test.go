...
func TestRenderPlacesTheClient(t *testing.T) {
	...
	if !strings.HasPrefix(index, "// Code generated by nightseam. DO NOT EDIT.\n") || !strings.Contains(index, "export function toWire(model: Protocol.ClientModel, context: AdapterContext): Endpoint") || !strings.Contains(index, "export async function fromWire(wire: Endpoint, context: AdapterContext): Promise<Protocol.ClientModel>") {
