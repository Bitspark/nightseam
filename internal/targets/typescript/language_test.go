...
func TestTypeParameterBindingsCannotShadowAdapterLocals(t *testing.T) {
	for _, name := range []string{"Context", "Bindings", "Slots", "Environment", "Observer", "ProxyServer", "ProxyClient", "BindServer", "BindClient", "Wire", "Model", "Adapter", "Access", "Binding", "Bound"} {
