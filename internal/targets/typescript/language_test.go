...
func TestTypeParameterBindingsCannotShadowAdapterLocals(t *testing.T) {
	for _, name := range []string{"Context", "Bindings", "Slots", "Environment", "Observer", "Propagator", "RequestTimeoutMs", "HasModelHandler", "ProxyServer", "ProxyClient", "BindServer", "BindClient", "Wire", "Model", "Adapter", "Access", "Binding", "Dispatcher", "Bound"} {
