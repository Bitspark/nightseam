...
func Declared(_ context.Context, wire bitwire.Endpoint) (bitwire.Endpoint,func(),error) {
 family,err:=adapter.Declared(wire);if err!=nil{return nil,nil,err}
 root,err:=duplex.ComposeDeclared(duplex.RefusingOrigin{},[]duplex.DeclaredChild{{Key:"family",Wire:family.Bind()}});if err!=nil{return nil,nil,err}
