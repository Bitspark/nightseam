...
var schemas = map[string]string{"model": "urn:nightseam:v1:model", "protocol": "urn:nightseam:v1:protocol", "session": "urn:nightseam:v1:session", "live": "urn:nightseam:v1:live"}
