// Package duplex is the seam beneath every protocol: a
...
// nightseam.duplex/1 profile runs over it, and through the profile every
// family of API; beneath it the transport is a WebSocket today
