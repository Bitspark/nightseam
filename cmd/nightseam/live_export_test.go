...
func TestGeneratedLiveExportRollback(t *testing.T) {
	...
	config := map[string]any{"compilerOptions": map[string]any{
		...
		"paths":     map[string]any{"@example/*": []string{"./api/ts/*/src/index.ts"}, "@example/*/types": []string{"./api/ts/*/src/types.ts"}, "@nightseam/runtime": []string{"./runtime/ts/src/index.ts"}, "@nightseam/duplex": []string{"./duplex/ts/src/index.ts"}, "@nightseam/tunnel": []string{"./tunnel/ts/src/index.ts"}, "@nightseam/live": []string{"./live/ts/src/index.ts"}},
