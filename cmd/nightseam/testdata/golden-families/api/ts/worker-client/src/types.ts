...
export function exportCancel(scope: LiveScope, value: Cancel): Reference {
  return scope.export(contractCancel, async (request, options) => {
    await value(options);
    return undefined;
  });
}
...
export function exportRename(scope: LiveScope, value: Rename): Reference {
  return scope.export(contractRename, async (request, options) => {
...
export function exportReport(scope: LiveScope, value: Report): Reference {
  return scope.export(contractReport, async (request, options) => {
