...
export async function pair<S extends AnyFamily = AnyFamily, Item = unknown>(model: Protocol.ClientModel<S, Item>, options: Options, s: FamilyBinding<S>, item: ValueAdapter<Item>): Promise<{ model: Protocol.ClientModel<S, Item>; close(): void }> {
...
export async function smoke<S extends AnyFamily = AnyFamily, Item = unknown>(model: Protocol.ClientModel<S, Item>, opposite: Protocol.Server<S, Item>, options: Options, s: FamilyBinding<S>, item: ValueAdapter<Item>): Promise<void> {
