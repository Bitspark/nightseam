...
func ToWire[SEnvelope runtime.Of[STag], SHandle runtime.Of[STag], Item any, STag any](model protocol.ClientModel[SEnvelope, SHandle, Item], environment runtime.AdapterContext, adapterItem runtime.ValueAdapter[Item]) (duplex.Wire, error) {
	if model == nil {
...
func Record[SEnvelope runtime.Of[STag], SHandle runtime.Of[STag], Item any, STag any](ctx context.Context, target duplex.Wire, log duplex.WireLog, options duplex.RecordOptions, environment runtime.AdapterContext, adapterItem runtime.ValueAdapter[Item]) (*Recorder[SEnvelope, SHandle, Item], error) {
	...
	return &Recorder[SEnvelope, SHandle, Item]{RecordedWire: wire, events: accessServer[SEnvelope, SHandle, Item](wire, environment, adapterItem).Events, identity: identity, options: environment.Options}, nil
}
