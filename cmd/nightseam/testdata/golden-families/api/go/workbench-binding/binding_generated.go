...
func Declared(access bitwire.Wire) (duplex.Declared, error) {
	children := make([]duplex.DeclaredChild, 0, 16)
	for _, name := range []string{runtime.IdentityMethod, "events.list", "me", "projects.create", "projects.list", "projects.update", "subscribe", "work.cancel", "work.create", "work.dependencies", "work.get", "work.list", "work.publish", "work.reopen", "work.steps", "work.update"} {
...
type RecordedChanged struct{ Data protocol.Event }
