...
// Control: Who holds control of the session, or nobody.
type Control struct {
	Holder runtime.Nullable[string] `json:"holder"`
}

func (v Control) MarshalJSON() ([]byte, error) {
	type wire Control
	data, err := runtime.MarshalJSON(wire(v))
	if err != nil {
		return nil, err
	}
	if err = schema.ValidateExpressionRaw("Control", data); err != nil {
		return nil, err
	}
	return data, nil
}
func (v *Control) UnmarshalJSON(data []byte) error {
	if err := schema.ValidateExpressionRaw("Control", data); err != nil {
		return err
	}
	type wire Control
...
func (Control) Of() Tag { return Tag{} }
func (Control) WireType() runtime.TypeBinding {
	return runtime.TypeBinding{Schema: schema, Type: "Control"}
}

// Cursor: Where an attachment stands in the log.
type Cursor struct {
...
func (v Cursor) MarshalJSON() ([]byte, error) {
	...
	if err = schema.ValidateExpressionRaw("Cursor", data); err != nil {
		return nil, err
	}
	return data, nil
}
...
func (Cursor) Of() Tag { return Tag{} }
func (Cursor) WireType() runtime.TypeBinding {
	return runtime.TypeBinding{Schema: schema, Type: "Cursor"}
}
