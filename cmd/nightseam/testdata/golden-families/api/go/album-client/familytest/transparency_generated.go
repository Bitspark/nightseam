...
import (
	...
	json "encoding/json"
	errors "errors"
	adapter "example.test/generated/api/go/album-client"
...
type observingMethods[AEnvelope, BEnvelope any] struct {
	inner protocol.ClientMethods[AEnvelope, BEnvelope]
...
func Smoke[AEnvelope runtime.Of[ATag], BEnvelope runtime.Of[BTag], ATag, BTag any](ctx context.Context, model protocol.ClientModel[AEnvelope, BEnvelope], opposite protocol.Server[AEnvelope, BEnvelope], options Options) error {
	...
	observed := func(remote protocol.Server[AEnvelope, BEnvelope]) (protocol.Client[AEnvelope, BEnvelope], error) {
