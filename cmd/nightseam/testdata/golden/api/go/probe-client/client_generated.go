...
func ToWire(model protocol.ClientModel, environment runtime.AdapterContext) (bitwire.Endpoint, error) {
	...
	if err := bindClient(dispatcher, func() protocol.Client { return implementation }, environment); err != nil {
		return nil, err
	}
	complete = true
	return access, nil
...
func Declared(access bitwire.Wire) (duplex.Declared, error) {
	...
	for _, name := range []string{runtime.IdentityMethod, "changed", "reverse"} {
...
func PrepareFromWire(wire bitwire.Endpoint, environment runtime.AdapterContext) (complete func(context.Context) (protocol.ClientModel, error), cleanup func(), err error) {
	if wire == nil {
...
type RecordedNoticed struct{ Data protocol.Seen }

func (RecordedNoticed) recordedEvent() {}
...
func (r *Recorder) Append(ctx context.Context, event RecordedEvent) error {
	...
	case RecordedNoticed:
		return r.events.Noticed(ctx, value.Data)
	case *RecordedNoticed:
		if value == nil {
