...
func (c *Client) NoArgs(ctx context.Context) (string, error) {
	...
	if err := protocol.ValidateExpressionRaw(protocol.TypeExpression("\"string\""), raw); err != nil {
		return result, err
	}
	if err := json.Unmarshal(raw, &result); err != nil {
		return result, err
...
func (c *Client) Seen(ctx context.Context, params protocol.Seen) (protocol.Payloads, error) {
	...
	if err := protocol.ValidateValue(protocol.TypeExpression("\"Seen\""), params); err != nil {
		return result, err
	}
	var raw json.RawMessage
	...
	if err := protocol.ValidateExpressionRaw(protocol.TypeExpression("\"Payloads\""), raw); err != nil {
		return result, err
	}
	if err := json.Unmarshal(raw, &result); err != nil {
		return result, err
