...
type Caller interface {
	...
	Seen(ctx context.Context, params protocol.Seen) (protocol.Payloads, error)
}
...
func (c *Client) Seen(ctx context.Context, params protocol.Seen) (protocol.Payloads, error) {
	var result protocol.Payloads
	if err := protocol.ValidateValue(protocol.MustTypeExpression("\"Seen\""), params); err != nil {
		return result, err
	}
	var raw json.RawMessage
	if err := c.Peer.Call(ctx, "seen", params, &raw); err != nil {
		return result, err
	}
	if err := protocol.ValidateExpressionRaw(protocol.MustTypeExpression("\"Payloads\""), raw); err != nil {
		return result, err
	}
	if err := json.Unmarshal(raw, &result); err != nil {
		return result, err
...
func (c *Client) EmitNoticed(ctx context.Context, data protocol.Seen) error {
	if err := protocol.ValidateValue(protocol.MustTypeExpression("\"Seen\""), data); err != nil {
		return err
	}
