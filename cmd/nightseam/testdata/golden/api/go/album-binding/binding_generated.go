...
func ToWire[AEnvelope runtime.Of[ATag], BEnvelope runtime.Of[BTag], ATag, BTag any](model protocol.ServerModel[AEnvelope, BEnvelope], environment runtime.AdapterContext) (duplex.Wire, error) {
	if model == nil {
...
func Record[AEnvelope runtime.Of[ATag], BEnvelope runtime.Of[BTag], ATag, BTag any](ctx context.Context, target duplex.Wire, log duplex.WireLog, options duplex.RecordOptions, environment runtime.AdapterContext) (*Recorder[AEnvelope, BEnvelope], error) {
	...
	return &Recorder[AEnvelope, BEnvelope]{RecordedWire: wire, events: accessClient[AEnvelope, BEnvelope](wire, environment).Events, identity: identity, options: environment.Options}, nil
}
