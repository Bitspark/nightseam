...
func ToWire[AEnvelope runtime.Of[ATag], BEnvelope runtime.Of[BTag], ATag, BTag any](model protocol.ServerModel[AEnvelope, BEnvelope], environment runtime.AdapterContext, adapterAEnvelope runtime.ValueAdapter[AEnvelope], adapterBEnvelope runtime.ValueAdapter[BEnvelope]) (bitwire.Endpoint, error) {
	if model == nil {
...
func Declared(access bitwire.Wire) (duplex.Declared, error) {
	...
	for _, name := range []string{runtime.IdentityMethod, "look"} {
...
func PrepareFromWire[AEnvelope runtime.Of[ATag], BEnvelope runtime.Of[BTag], ATag, BTag any](wire bitwire.Endpoint, environment runtime.AdapterContext, adapterAEnvelope runtime.ValueAdapter[AEnvelope], adapterBEnvelope runtime.ValueAdapter[BEnvelope]) (complete func(context.Context) (protocol.ServerModel[AEnvelope, BEnvelope], error), cleanup func(), err error) {
	...
	if err = bindClient[AEnvelope, BEnvelope](preparation.Wire(), lookup, environment, adapterAEnvelope, adapterBEnvelope); err != nil {
		cleanup()
		return nil, nil, err
	}
	...
	complete = func(ctx context.Context) (protocol.ServerModel[AEnvelope, BEnvelope], error) {
		...
		return func(value protocol.Client[AEnvelope, BEnvelope]) (protocol.Server[AEnvelope, BEnvelope], error) {
			...
			return accessServer[AEnvelope, BEnvelope](preparation.Wire(), environment, adapterAEnvelope, adapterBEnvelope), nil
		}, nil
	}
...
func FromWire[AEnvelope runtime.Of[ATag], BEnvelope runtime.Of[BTag], ATag, BTag any](ctx context.Context, wire bitwire.Endpoint, environment runtime.AdapterContext, adapterAEnvelope runtime.ValueAdapter[AEnvelope], adapterBEnvelope runtime.ValueAdapter[BEnvelope]) (protocol.ServerModel[AEnvelope, BEnvelope], error) {
...
type Recorder[AEnvelope, BEnvelope any] struct {
	*duplex.RecordedWire
	events   protocol.ClientEvents[AEnvelope, BEnvelope]
...
func Record[AEnvelope runtime.Of[ATag], BEnvelope runtime.Of[BTag], ATag, BTag any](ctx context.Context, target bitwire.Endpoint, log duplex.WireLog, options duplex.RecordOptions, environment runtime.AdapterContext, adapterAEnvelope runtime.ValueAdapter[AEnvelope], adapterBEnvelope runtime.ValueAdapter[BEnvelope]) (*Recorder[AEnvelope, BEnvelope], error) {
	...
	return &Recorder[AEnvelope, BEnvelope]{RecordedWire: wire, events: accessClient[AEnvelope, BEnvelope](wire, environment, adapterAEnvelope, adapterBEnvelope).Events, identity: identity, options: environment.Options}, nil
}
