...
<!-- Generated by nightseam from api/contracts/proof/; do not edit. -->
...
Used by `Parts` (alias), `classify` (request).
...
Used by `classify_rich` (request), `part.added` (data).
...
|---|---|---|---|---|
| `echo` | `probe.Payload` | `probe.Payload` | — | Inherited from `probe`. |
| `no_args` | — | `string` | — | Inherited from `probe`. |
| `classify` | `Part` | `string` | — | Dispatches a base part by its tag after the generated binding decodes it. |
| `classify_rich` | `RichPart` | `string` | — | Dispatches a widened part by its tag after the generated binding decodes it. |
...
|---|---|---|
| `changed` | `probe.Payload` | Inherited from `probe`. |
