...
func ToWire[SJob runtime.Of[STag], SProgress runtime.Of[STag], STag any](model protocol.ClientModel[SJob, SProgress], environment runtime.AdapterContext, adapterSJob runtime.ValueAdapter[SJob], adapterSProgress runtime.ValueAdapter[SProgress]) (duplex.Endpoint, error) {
	if model == nil {
...
func FromWire[SJob runtime.Of[STag], SProgress runtime.Of[STag], STag any](ctx context.Context, wire duplex.Endpoint, environment runtime.AdapterContext, adapterSJob runtime.ValueAdapter[SJob], adapterSProgress runtime.ValueAdapter[SProgress]) (protocol.ClientModel[SJob, SProgress], error) {
