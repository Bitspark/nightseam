...
func bindServer[SJob, SProgress any](wire runtime.HandlerRegistry, lookup func() protocol.Server[SJob, SProgress], environment runtime.AdapterContext, adapterSJob runtime.ValueAdapter[SJob], adapterSProgress runtime.ValueAdapter[SProgress]) error {
	var detach []func()
	complete := false
	defer func() {
		if !complete {
...
func ToWire[SJob runtime.Of[STag], SProgress runtime.Of[STag], STag any](model protocol.ClientModel[SJob, SProgress], environment runtime.AdapterContext, adapterSJob runtime.ValueAdapter[SJob], adapterSProgress runtime.ValueAdapter[SProgress]) (bitwire.Endpoint, error) {
	if model == nil {
	...
	if err := bindClient[SJob, SProgress](dispatcher, func() protocol.Client[SJob, SProgress] { return implementation }, environment, adapterSJob, adapterSProgress); err != nil {
		return nil, err
	}
	complete = true
	return access, nil
...
func FromWire[SJob runtime.Of[STag], SProgress runtime.Of[STag], STag any](ctx context.Context, wire bitwire.Endpoint, environment runtime.AdapterContext, adapterSJob runtime.ValueAdapter[SJob], adapterSProgress runtime.ValueAdapter[SProgress]) (protocol.ClientModel[SJob, SProgress], error) {
