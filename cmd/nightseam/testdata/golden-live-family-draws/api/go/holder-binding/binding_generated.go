...
func ToWire[SJob runtime.Of[STag], SProgress runtime.Of[STag], STag any](model protocol.ServerModel[SJob, SProgress], environment runtime.AdapterContext, adapterSJob runtime.ValueAdapter[SJob], adapterSProgress runtime.ValueAdapter[SProgress]) (bitwire.Endpoint, error) {
	...
	if err := bindServer[SJob, SProgress](dispatcher, func() protocol.Server[SJob, SProgress] { return implementation }, environment, adapterSJob, adapterSProgress); err != nil {
		return nil, err
	}
	complete = true
	return access, nil
...
func Declared(access bitwire.Wire) (duplex.Declared, error) {
	...
	for _, name := range []string{runtime.IdentityMethod, "exchange"} {
